...
var setDB = exports.setDB = function setDB(newDB) {
  db = preprocess(newDB);
};
...
var searchAddressByDistrict = exports.searchAddressByDistrict = function searchAddressByDistrict(searchStr, maxResult) {
  return resolveResultbyField('district', searchStr, maxResult);
};
var searchAddressByAmphoe = exports.searchAddressByAmphoe = function searchAddressByAmphoe(searchStr, maxResult) {
  return resolveResultbyField('amphoe', searchStr, maxResult);
};
var searchAddressByProvince = exports.searchAddressByProvince = function searchAddressByProvince(searchStr, maxResult) {
  return resolveResultbyField('province', searchStr, maxResult);
};
var searchAddressByZipcode = exports.searchAddressByZipcode = function searchAddressByZipcode(searchStr, maxResult) {
